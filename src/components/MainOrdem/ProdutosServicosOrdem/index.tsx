...
interface ProdutosServicosOrdemProps {
  ordem: Ordem,
  ordemId,
  controller: string,
...
function ProdutosServicosOrdem({ ordem, controller, onSaveOrder, ordemId }: ProdutosServicosOrdemProps) {
  ...
  return (
    <>
      <h1>ProdutosServicosOrdem</h1>

    </>
  );
}

export default ProdutosServicosOrdem;
